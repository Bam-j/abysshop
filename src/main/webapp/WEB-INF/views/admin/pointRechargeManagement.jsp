...
<section>
  ...
  <div class="pagination">
    ...
    <c:if test="${currentPage > 1}">
      <a href="?menu=point-recharge-management&page=${currentPage - 1}" class="page-link">이전</a>
    </c:if>
    ...
    <c:if test="${currentPage < totalPages}">
      <a href="?menu=point-recharge-management&page=${currentPage + 1}" class="page-link">다음</a>
    </c:if>
  </div>
