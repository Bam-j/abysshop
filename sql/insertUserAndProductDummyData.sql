...
BEGIN
  ...
  VALUES ('상품1', 10000, '상품 설명1', 'goods'),
         ('상품2', 20000, '상품 설명2', 'point'),
         ('상품3', 10000, '상품 설명3', 'goods'),
         ('상품4', 20000, '상품 설명4', 'point'),
         ('상품5', 10000, '상품 설명5', 'goods'),
         ('상품6', 20000, '상품 설명6', 'point'),
         ('상품7', 10000, '상품 설명7', 'goods'),
         ('상품8', 20000, '상품 설명8', 'point'),
         ('상품9', 10000, '상품 설명9', 'goods'),
         ('상품10', 20000, '상품 설명10', 'point'),
         ('상품11', 10000, '상품 설명11', 'goods'),
         ('상품12', 20000, '상품 설명12', 'point'),
         ('상품13', 10000, '상품 설명13', 'goods'),
         ('상품14', 20000, '상품 설명14', 'point'),
         ('상품15', 10000, '상품 설명15', 'goods'),
         ('상품16', 20000, '상품 설명16', 'point'),
         ('상품17', 10000, '상품 설명17', 'goods'),
         ('상품18', 20000, '상품 설명18', 'point'),
         ('상품19', 10000, '상품 설명19', 'goods'),
